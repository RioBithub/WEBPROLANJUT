...
<head>
    ...
    <style>
        ...
        .first-image {
           max-width: 20%; /* Set the maximum width for the first image */
           height: auto;
           border-radius: 8px;
        ...
        .second-image {
           max-width: 20%; /* Set the maximum width for the second image */
           height: auto;
           border-radius: 8px;
           margin-right: auto; /* Move the second image to the right */
        }
        ...
        .image-container p {
           ...
           margin-right: 20px; /* Adjust the spacing between the caption and the second image */
        }
    </style>
</head>
<body>
